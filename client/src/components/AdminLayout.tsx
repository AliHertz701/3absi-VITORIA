          ...
          <div className="flex items-center justify-between px-4 sm:px-6 lg:px-8 h-20">
            ...
            <div className="flex items-center gap-2 sm:gap-4">
              ...
              <motion.button
                ...
                className="hidden sm:flex items-center gap-2 px-4 py-2 rounded-xl bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors"
              >
                <Search className="w-4 h-4" />
                <span className="text-sm font-medium">{t('general.search')}</span>
                <kbd className="hidden md:inline-flex px-2 py-0.5 text-xs bg-white rounded border border-gray-300">⌘K</kbd>
              </motion.button>
